...
public class StructuriAlternative {
    ...
    //in programare există două tipuri de structuri: alternative și repetitive
...
//        verificNrDivizibil(6);
    ...
    //sa verificam daca un numar este par si pozitiv
    //daca vrem câtul unei impartiri => / (div)
    //dac vrem restul unei impartiri => / (mod)
    ...
    public void zileSaptamana(int zi){
        switch (zi){
            ...
            case 7:
                ...
                break;
            default:
                System.out.println("Nu mai există zile");
        }
    }
